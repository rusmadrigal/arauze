...
export const metadata: Metadata = {
  ...
  title: "Arauze.com – avviso di giacenza, raccomandate, codici tributo e CMP in Italia",
  description:
    "Consulta gli avvisi di giacenza, i codici Raccomandata Market, i codici tributo e i centri CMP per le comunicazioni certificate e i pagamenti in Italia.",
  openGraph: {
    siteName: "Arauze.com",
    type: "website",
    locale: "it_IT",
