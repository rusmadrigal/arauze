      ...
      <div className="rounded-2xl shadow-card bg-white p-6 md:p-10">
        ...
        <section className="space-y-10 text-gray-700 text-[15px] leading-relaxed">
          <Block id="uso" title="1. Uso del sito">
            <p>
              Le informazioni pubblicate su <strong>Arauze.com</strong> hanno solo scopo
              informativo. L’utente si impegna a utilizzare il sito in modo lecito, senza
              arrecare danno a sistemi, dati o terze parti, e nel rispetto della normativa
              vigente.
            </p>
          </Block>
          ...
          <Block id="proprieta" title="2. Proprietà intellettuale">
            <p>
              Testi, loghi, grafiche e layout sono di proprietà di Arauze (o dei
              rispettivi titolari con licenza). È vietata qualsiasi riproduzione o
          ...
          <Block id="limitazioni" title="3. Limitazioni di responsabilità">
            <Callout>
              Arauze non garantisce l’assenza di errori, interruzioni o inesattezze. L’uso
              delle informazioni avviene a proprio rischio. Nei limiti consentiti dalla
              legge, Arauze non risponde di danni diretti o indiretti derivanti
          ...
          <Block id="contenuti" title="4. Contenuti e link di terzi">
            <p>
              Il sito può includere collegamenti o riferimenti a risorse esterne. Arauze
              non controlla né approva tali contenuti e non è responsabile per materiali,
              politiche o pratiche di siti di terzi.
            </p>
          </Block>
          ...
          <Block id="account" title="5. Account & condotte vietate">
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                È vietata l’introduzione di malware, scraping aggressivo o attività di
                spam.
              </li>
              <li>
                Se l’utente crea un account (ove disponibile), è responsabile della
          ...
          <Block id="modifiche" title="6. Modifiche del servizio e dei termini">
            <p>
              Arauze può aggiornare funzioni, contenuti o i presenti termini per motivi
              tecnici o legali. Le modifiche saranno pubblicate su questa pagina con data
              di aggiornamento.
            </p>
          </Block>
          ...
          <Block id="legge" title="7. Legge applicabile & Foro competente">
            <p>
              ...
              è competente in via esclusiva il Foro individuato dalla normativa
              applicabile.
            </p>
          </Block>
