      ...
      <div className="rounded-2xl shadow-card bg-white p-6 md:p-10">
        ...
        <section className="space-y-10 text-gray-700 text-[15px] leading-relaxed">
          ...
          <Block id="form" title="2. Invia un messaggio">
            <p>
              Compila il modulo sottostante per inviare un messaggio diretto al nostro
              team. Ti risponderemo appena possibile.
            </p>
            <form
          ...
          <Block id="mappa" title="3. Dove operiamo">
            <p>
              Arauze è una piattaforma digitale online, accessibile da qualsiasi paese
              dell’Unione Europea.
            </p>
