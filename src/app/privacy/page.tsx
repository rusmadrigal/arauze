        ...
        <section className="space-y-10 text-gray-700 text-[15px] leading-relaxed">
          <div id="intro" className="space-y-3">
            <p>
              ...
              personali raccolti attraverso il sito <strong>Arauze.com</strong>, in
              conformità al Regolamento (UE) 2016/679 (GDPR) e alla normativa italiana
              applicabile.
            </p>
          </div>
          ...
          <Block id="conservazione" title="5. Conservazione & Sicurezza">
            <p>
              I dati sono conservati su infrastrutture sicure e protetti da misure
              tecniche e organizzative adeguate. I tempi di conservazione sono limitati
              allo stretto necessario per le finalità indicate.
            </p>
          </Block>
          ...
          <Block id="terze" title="6. Condivisioni a terzi">
            <p>
              Non cediamo i dati a terze parti non autorizzate. Eventuali fornitori (es.
              hosting, analytics) trattano i dati in qualità di responsabili, secondo
              accordi conformi al GDPR.
            </p>
          </Block>
          ...
          <Block id="cookie" title="8. Cookie & analytics">
            <p>
              Utilizziamo cookie tecnici essenziali. Eventuali cookie di analisi (se
              presenti) sono configurati in forma aggregata/anonymizzata. Puoi gestire le
              preferenze dal tuo browser.
            </p>
          </Block>
          ...
          <Block id="modifiche" title="9. Modifiche all’informativa">
            <p>
              Ci riserviamo il diritto di aggiornare la presente informativa per adeguarla
              a evoluzioni normative o tecniche. Le modifiche saranno pubblicate su questa
              pagina.
            </p>
          </Block>
